...
def getImageFromlocation(location):
    url = 'https://maps.googleapis.com/maps/api/staticmap?center=' + location + '&zoom=6&size=800x800&maptype=roadmap&scale=2&key=AIzaSyCNQX5-4_hPDpluC7j-EZK13Oixn_47DpM'
